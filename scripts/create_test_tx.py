...
def create_test_tx():
    ...
    # Create transaction (send 0.001 ETH to self)
    tx = {
        'type': 2,  # EIP-1559
    ...
    bundle_request = {
        "tx1": signed_tx.raw_transaction.hex(),
        "payment": {
            "mode": "direct",
            "formula": "flat",
        ...
        "targets": {
            "blocks": [latest_block.number + 1, latest_block.number + 2]
        }
    }
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"  • tx1 raw: {signed_tx.raw_transaction.hex()}")
